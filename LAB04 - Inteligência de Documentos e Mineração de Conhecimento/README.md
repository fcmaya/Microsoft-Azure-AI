...
Vamos imaginar que você trabalhe para a Fourth Coffee, uma rede nacional de cafés. Você é solicitado a ajudar a criar uma solução de mineração de conhecimento que facilite a pesquisa de insights sobre as experiências do cliente. Você decide criar um índice de Pesquisa de IA do Azure usando dados extraídos de avaliações de clientes.

Neste exercício, utilizamos os recursos do Azure AI Search.
...
- Uma Storage account com contêineres de blob, que armazenará documentos brutos e outras coleções de tabelas, objetos ou arquivos.
- Upload para o Storage account das avaliações dos clientes do endereço https://aka.ms/mslearn-coffee-reviews

## Indexar os documentos

Depois de ter os documentos em armazenamento, você pode usar o Azure AI Search para extrair insights dos documentos. O portal do Azure fornece um assistente de Importação de dados. Com esse assistente, você pode criar automaticamente um índice e um indexador para fontes de dados com suporte. Você usará o assistente para criar um índice e importar seus documentos de pesquisa do armazenamento para o Azure AI Search index.

## Consultar o índice

Use o Search explorer para escrever e testar consultas. O Search explorer é uma ferramenta incorporada no portal do Azure que oferece uma maneira fácil de validar a qualidade do seu índice de pesquisa. Você pode usar o Search explorer para escrever consultas e revisar resultados em JSON.
...
```json
{
  "@odata.context": "https://instance-maya.search.windows.net/indexes('coffee-index')/$metadata#docs(*)",
  "@odata.count": 9,
  "value": [
    {
      "@search.score": 1,
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy00LmRvY3g1",
      "locations": [
        "Fourth Coffee",
        "Chicago",
        "Illinois"
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy04LmRvY3g1",
      "locations": [
        "Chicago",
        "Illinois"
      ],
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy02LmRvY3g1",
      "locations": [
        "Fourth Coffee",
        "Seattle",
        "Washington"
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy0yLmRvY3g1",
      "locations": [
        "school",
        "University hub",
        "Los Angeles",
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy01LmRvY3g1",
      "locations": [
        "meeting spot",
        "Chicago",
        "Illinois"
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy03LmRvY3g1",
      "locations": [
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy0xLmRvY3g1",
      "locations": [
        "Seattle",
        "Washington"
      ],
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy05LmRvY3g1",
      "locations": [
        "Seattle",
        "Washington"
      ],
    ...
    },
    {
      ...
      "metadata_storage_path": "aHR0cHM6Ly9zdG9yYWdlYWNjb3VudG1heWEuYmxvYi5jb3JlLndpbmRvd3MubmV0L2NvZmZlZS1yZXZpZXdzL3Jldmlldy0zLmRvY3g1",
      "locations": [
        "Seattle",
        "Washington",
        "Café 50"
...
### Entrada 02: 
A consulta pesquisa todos os documentos no índice e filtra por revisões com um local de Chicago.
```json
{
...
### Entrada 03: 
A consulta pesquisa todos os documentos no índice e filtra por avaliações com um sentimento negativo.
```json
{
